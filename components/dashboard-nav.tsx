...
import { Lock, BarChart3, Upload, Zap, ShieldCheck, LogOut, Sparkles } from "lucide-react"
import { clearStoredUser, isAdmin } from "@/lib/auth"
...
export function DashboardNav() {
  ...
  const navItems = [
    ...
    ...(adminUser ? [{ href: "/dashboard/enroll", label: "Enroll", icon: Upload }] : []),
    { href: "/dashboard/match", label: "Match", icon: Zap },
    { href: "/dashboard/verify", label: "2FA Verify", icon: ShieldCheck },
  ]
